...
/** Enforce a role-matrix capability for service methods that receive a context. */
export function requireCapability(ctx: CrmContext, permission: Permission): void {
