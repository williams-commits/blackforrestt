 ...
 * instruments. All visuals are inline SVG/CSS; no external image files or CDN.
 * CSP-safe, theme-aware (fixed brand colours with a token-based ring).
 *
 * Category designs:
